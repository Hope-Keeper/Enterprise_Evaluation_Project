...
function ReihanBreadcrumbs(props: ReihanBreadcrumbsPropsType) {
...
export default ReihanBreadcrumbs;

interface ReihanBreadcrumbsPropsType extends BreadcrumbsProps {
