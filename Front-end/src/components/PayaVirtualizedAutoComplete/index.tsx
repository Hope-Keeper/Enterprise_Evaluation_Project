...
import PayaTextField from "components/PayaTextField";
...
export default function PayaVirtualizedAutoComplete(props: PayaVirtualizedAutoCompletePropsType) {
    ...
    return (
        <Autocomplete
            ...
            renderInput={(params) => <PayaTextField {...params} label="100,000 اسم و فامیل" />}
...
interface PayaVirtualizedAutoCompletePropsType
