...
function PayaAutocompleteHighlight(props: PayaAutocompleteHighlightPropsType) {
...
export default PayaAutocompleteHighlight;
...
interface PayaAutocompleteHighlightPropsType
