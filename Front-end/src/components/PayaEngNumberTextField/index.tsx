...
function PayaEngNumberTextField(props: PayaEngNumberTextFieldPropsType) {
...
export default PayaEngNumberTextField;

type PayaEngNumberTextFieldPropsType = TextFieldProps & {
    inputValue: string;
