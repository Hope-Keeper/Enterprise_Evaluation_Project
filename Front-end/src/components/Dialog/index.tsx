...
function ReihanDialog(props: ReihanDialogProps) {
    const {
        DialogContents,
        handleClose,
        title,
    ...
    return (
        <Dialog
            ...
            <DialogTitle
                sx={(theme) => ({
                    backgroundColor: dangerous
                        ...
                        : theme.palette.dialogTitleBgColor.main,
            ...
            <DialogContent
                ...
                {typeof DialogContents === "function" ? <DialogContents /> : DialogContents}
            </DialogContent>
...
export default ReihanDialog;

interface ReihanDialogPropsBase extends DialogProps {
    DialogContents: ReactNode | FC;
    handleClose: () => void;
    title: string;
    handleCancel?: () => void;
...
interface ReihanDialogPropsWithConfirm extends ReihanDialogPropsBase {
    confirmDialog: true;
    handleAccept: () => void;
...
interface ReihanDialogPropsWithoutConfirm extends ReihanDialogPropsBase {
    confirmDialog?: false;
    handleAccept?: () => void;
    actionButtons?: ReactNode;
...
type ReihanDialogProps = ReihanDialogPropsWithConfirm | ReihanDialogPropsWithoutConfirm;
