...
> ⚠️ This repo demonstrates the architecture and patterns used in a real-world enterprise project under NDA. Business logic is omitted, but structure, approach, and tech choices reflect actual work experience.
...
This example includes one microservice: `user-service`, built using DDD structure:

## 🧩 System Architecture

![System Diagram](Back-end/docs/flow2.png)
![System Diagram](Back-end/docs/page1.png)
![System Diagram](Back-end/docs/page2.png)
